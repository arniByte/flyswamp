...
- **P2 в работе**, подробности — в `docs/SCIENCE.md`, раздел P2.
  ...
  - Сахар → MN9 воспроизводится: правые GRN → MN9_L 87 Hz при `w_syn` 0,20, у FlyWire 86 Hz (контралатеральный MN9).
...
- **Следующие шаги:**
  - набор бенчмарков и контроль с перемешанной проводкой готовы (`validation/p2_bench.mjs`). Вода разобрана (`pathway_compare.mjs`, `water_grn_targets.py`): в MaleCNS нет левого CB0407, у MN9_R 633 входа против 6 358 у MN9_L. Поэтому бенчмарк MaleCNS идёт с правых GRN, читается MN9_L. При `w_syn` 0,20 без SFA проходит все критерии на сидах 1–5;
